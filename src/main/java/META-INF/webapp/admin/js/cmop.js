...
function switchTab() {
    ...
    nextSteps.click(function () {
        ...
        $("#selectedResources #singleResources").each(function () {
            str += "<tr class='ResourcesDetail'>" + "<td>计算资源</td>" + "<td>" + $(this).children("#osName_SingleResources").text() + "&nbsp;" + $(this).children("#osBitName__SingleResources").text() + "<code>规格:</code>" + $(this).children("#serverTypeName__SingleResources").text() + "<code>数量:</code>" + $(this).children("#serverCount__SingleResources").text() + "" + "</td>" + "</tr>";
...
function selectServer(object, modalObject) {
    ...
    if (smallCount != "") { //数量框不为空
        ...
        $("#selectedResources #singleResources").each(function () {
            ...
            if ($(this).children("#osId_SingleResources").text() == osId && $(this).children("#osBitId__SingleResources").text() == checkOsBit && $(this).children("#serverTypeId__SingleResources").text() == smallTypeId) {
                $(this).remove();
            }
        });
    ...
    if (middleCount != "") { //数量框不为空
        ...
        //如果已有相同的OS,Bit和规格,则删除已有的.
        $("#selectedResources #singleResources").each(function () {
            if ($(this).children("#osId_SingleResources").text() == osId && $(this).children("#osBitId__SingleResources").text() == checkOsBit && $(this).children("#serverTypeId__SingleResources").text() == middleTypeId) {
                $(this).remove();
            }
        });
    ...
    if (largeCount != "") { //数量框不为空
        ...
        //如果已有相同的OS,Bit和规格,则删除已有的.
        $("#selectedResources #singleResources").each(function () {
            if ($(this).children("#osId_SingleResources").text() == osId && $(this).children("#osBitId__SingleResources").text() == checkOsBit && $(this).children("#serverTypeId__SingleResources").text() == largeTypeId) {
                $(this).remove();
            }
        });
