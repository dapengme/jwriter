 ...
 * (<a href="http://iharder.net/base64">http://iharder.net/base64</a>). Modified
 * by Erwin Vervaet to use the '.' character as padding character when using URL
 * safe encoding, like in the Bouncy Castle URLBase64 encoder (<a
 * href="http://www.bouncycastle.org/java.html"
 * >http://www.bouncycastle.org/java.html</a>).
 * 
