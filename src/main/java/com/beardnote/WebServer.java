...
public class WebServer {
    ...
    private static final String CLASS_ONLY_AVAILABLE_IN_IDE = "com.beardnote.IDE";
    private static final String PROJECT_RELATIVE_PATH_TO_WEBAPP = "src/main/java/META-INF/webapp";
    private static final String JETTY_WEBDEFAULT = "src/main/java/META-INF/webapp/WEB-INF/webdefault.xml";
    ...
    private HandlerCollection createHandlers() {
        ...
        _ctx.setContextPath("/");
        _ctx.setDefaultsDescriptor(JETTY_WEBDEFAULT);
