    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException,
        ...
        try {
            ...
            if (null == userinfo) {
                ...
                response.sendRedirect(request.getContextPath() + Constants.Front.USER_LOGIN + "?goto_page=" + reqUrl);
            } else {
            ...
            response.sendRedirect(request.getContextPath() + Constants.Front.USER_LOGIN);
        }
    }
